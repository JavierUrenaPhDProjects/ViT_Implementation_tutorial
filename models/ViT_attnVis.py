...
def VisionTransformer_attnVis(args):
...
# ViT Base:
def vit_768_12_12_attnVis(args):
    model = ViT(image_size=args['img_size'],
                patch_size=args['patch_size'],
                num_classes=args['n_classes'],
                dim=768,
...
# ViT Large:
def vit_1024_24_16_attnVis(args):
    model = ViT(image_size=args['img_size'],
                patch_size=args['patch_size'],
                num_classes=args['n_classes'],
                dim=1024,
